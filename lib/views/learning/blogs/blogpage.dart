...
class _Blog_PageState extends State<Blog_Page> {
    ...
    return PreferredSize(
        ...
        child: Container(
          ...
          child: Row(
            ...
            Text('Blog Page',style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold,color: Colors.white),),
                  ...
                  onTap: (
                     ...
                     Get.dialog(
                      Dialog(
                        ...
                        shape:Border.all(width: 1,color:Color.fromRGBO(34, 51, 69, 1.0), ),
                      )
                     );
                  },
  ...
  Widget buildBlock(){
    return  StreamBuilder(stream: FirebaseFirestore.instance.collection('posts').orderBy('timestamp',descending: true).snapshots(),
